        ...
        const [pythonResult, qvacResult] = await Promise.all([
            ...
            (async ()=>{
                ...
                const history = [
                    {
                        role: "system",
                        content: "Extrae metadatos en JSON estricto. Usa 'Desconocido' si falta algo."
                    },
                    {
                        role: "user",
                        content: `Devuelve JSON con: "remitente", "destinatario", "incoterm".\n\nTEXTO:\n${primeraPagina}`
                    }
                ];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0qtk6t7._.js.map